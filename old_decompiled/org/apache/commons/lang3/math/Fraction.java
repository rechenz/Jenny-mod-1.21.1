...
implements Comparable<Fraction> {
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        ...
        BigInteger w2 = t2.divide(BigInteger.valueOf(d22 = (tmodd1 = t2.mod(BigInteger.valueOf(d12)).intValue()) == 0 ? d12 : Fraction.greatestCommonDivisor(tmodd1, d12)));
        if (w2.bitLength() > 31) {
            throw new ArithmeticException("overflow: numerator too large after multiply");
        }
        return new Fraction(w2.intValue(), Fraction.mulPosAndCheck(this.denominator / d12, fraction.denominator / d22));
    }
