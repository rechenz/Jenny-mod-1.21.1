...
implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz, CompareToBuilder builder, boolean useTransients, String[] excludeFields) {
        ...
        for (int i2 = 0; i2 < fields.length && builder.comparison == 0; ++i2) {
            ...
            if (ArrayUtils.contains(excludeFields, ((Field)f10).getName()) || ((Field)f10).getName().contains("$") || !useTransients && Modifier.isTransient(((Field)f10).getModifiers()) || Modifier.isStatic(((Field)f10).getModifiers())) continue;
            try {
                builder.append(((Field)f10).get(lhs), ((Field)f10).get(rhs));
                continue;
            }
