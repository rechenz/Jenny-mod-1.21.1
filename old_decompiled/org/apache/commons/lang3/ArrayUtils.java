...
public class ArrayUtils {
    ...
    public static boolean[] toPrimitive(Boolean[] array, boolean valueForNull) {
        ...
        boolean[] result = new boolean[array.length];
        for (int i2 = 0; i2 < array.length; ++i2) {
            Boolean b10 = array[i2];
            result[i2] = b10 == null ? valueForNull : b10;
        }
        return result;
    }
    ...
    public static char[] toPrimitive(Character[] array, char valueForNull) {
        ...
        char[] result = new char[array.length];
        for (int i2 = 0; i2 < array.length; ++i2) {
            Character b10 = array[i2];
            result[i2] = b10 == null ? valueForNull : b10.charValue();
        }
        return result;
    }
    ...
    public static float[] toPrimitive(Float[] array, float valueForNull) {
        ...
        for (int i2 = 0; i2 < array.length; ++i2) {
            Float b10 = array[i2];
            result[i2] = b10 == null ? valueForNull : b10.floatValue();
        }
        return result;
    }
    ...
    public static Object toPrimitive(Object array) {
        ...
        Class<?> pt = ClassUtils.wrapperToPrimitive(ct2);
