...
Serializable {
    ...
    protected String parseToken(String pattern, int[] indexRef) {
        ...
        char c10 = pattern.charAt(i2);
        if (c10 >= 'A' && c10 <= 'Z' || c10 >= 'a' && c10 <= 'z') {
            char peek;
            buf.append(c10);
            while (i2 + 1 < length && (peek = pattern.charAt(i2 + 1)) == c10) {
                buf.append(c10);
                ++i2;
            }
        } else {
            ...
            for (i2 = indexRef[0]; i2 < length; ++i2) {
                ...
                if (inLiteral || (c10 < 'A' || c10 > 'Z') && (c10 < 'a' || c10 > 'z')) {
                    buf.append(c10);
                    continue;
                }
                break;
    ...
    public String format(long millis) {
        Calendar c10 = this.newCalendar();
        c10.setTimeInMillis(millis);
        return this.applyRulesToString(c10);
    }

    private String applyRulesToString(Calendar c10) {
        return this.applyRules(c10, new StringBuilder(this.mMaxLengthEstimate)).toString();
    }
    ...
    public StringBuffer format(long millis, StringBuffer buf) {
        Calendar c10 = this.newCalendar();
        c10.setTimeInMillis(millis);
        return this.applyRules(c10, (Appendable)buf);
    }
    ...
    public <B extends Appendable> B format(long millis, B buf) {
        Calendar c10 = this.newCalendar();
        c10.setTimeInMillis(millis);
        return this.applyRules(c10, buf);
    }
