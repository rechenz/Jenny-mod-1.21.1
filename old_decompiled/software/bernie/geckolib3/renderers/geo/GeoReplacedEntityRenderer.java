...
extends Render<EntityLivingBase>
implements IGeoRenderer {
    ...
    public void doRender(EntityLivingBase entity, double x2, double y2, double z2, float entityYaw, float partialTicks) {
        Entity leashHolder;
        ...
        float f10 = Interpolations.lerpYaw(entity.field_70760_ar, entity.field_70761_aq, partialTicks);
        float f12 = Interpolations.lerpYaw(entity.field_70758_at, entity.field_70759_as, partialTicks);
        ...
        if (entity instanceof EntityPlayer && !((EntityPlayer)entity).func_175149_v()) {
            for (GeoLayerRenderer layerRenderer : this.layerRenderers) {
                layerRenderer.func_177141_a(entity, limbSwing, limbSwingAmount, partialTicks, f72, netHeadYaw, headPitch, 0.0625f);
            }
        }
    ...
    protected void applyRotations(EntityLivingBase entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
        ...
        if (entityLiving.field_70725_aQ > 0) {
            float f10 = ((float)entityLiving.field_70725_aQ + partialTicks - 1.0f) / 20.0f * 1.6f;
            ...
            GlStateManager.func_179137_b((double)0.0, (double)(entityLiving.field_70131_O + 0.1f), (double)0.0);
