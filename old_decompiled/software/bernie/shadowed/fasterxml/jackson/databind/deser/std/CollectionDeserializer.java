...
implements ContextualDeserializer {
    ...
    protected CollectionDeserializer withResolved(JsonDeserializer<?> dd2, JsonDeserializer<?> vd, TypeDeserializer vtd, NullValueProvider nuller, Boolean unwrapSingle) {
        return new CollectionDeserializer(this._containerType, vd, vtd, this._valueInstantiator, dd2, nuller, unwrapSingle);
    }
    ...
    protected final Collection<Object> handleNonArray(JsonParser p2, DeserializationContext ctxt, Collection<Object> result) throws IOException {
        ...
        try {
            ...
            throw JsonMappingException.wrapWithPath((Throwable)e10, Object.class, result.size());
        }
        result.add(value);
        return result;
    }
