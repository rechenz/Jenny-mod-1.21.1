...
implements Serializable {
    ...
    public Object createUsingDefault(DeserializationContext ctxt) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._valueClass, null, this.rewrapCtorProblem(ctxt, e10));
        }
    }
    ...
    public Object createFromObjectWith(DeserializationContext ctxt, Object[] args) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._valueClass, args, this.rewrapCtorProblem(ctxt, e10));
        }
    }
    ...
    protected JsonMappingException wrapException(Throwable t2) {
        ...
        return new JsonMappingException(null, "Instantiation of " + this.getValueTypeDesc() + " value failed: " + t2.getMessage(), t2);
    }
