...
extends DatabindContext {
    ...
    protected SerializerProvider(SerializerProvider src, SerializationConfig config, SerializerFactory f10) {
    ...
    public <T> T reportBadDefinition(JavaType type, String msg, Throwable cause) throws JsonMappingException {
        InvalidDefinitionException e10 = InvalidDefinitionException.from(this.getGenerator(), msg, type);
        e10.initCause(cause);
        throw e10;
    }

    public <T> T reportBadDefinition(Class<?> raw, String msg, Throwable cause) throws JsonMappingException {
        InvalidDefinitionException e10 = InvalidDefinitionException.from(this.getGenerator(), msg, this.constructType(raw));
        e10.initCause(cause);
        throw e10;
    }
