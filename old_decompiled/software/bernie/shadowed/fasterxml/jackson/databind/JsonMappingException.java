...
extends JsonProcessingException {
    ...
    public static JsonMappingException from(JsonGenerator g10, String msg) {
        return new JsonMappingException((Closeable)g10, msg, (Throwable)null);
    }

    public static JsonMappingException from(JsonGenerator g10, String msg, Throwable problem) {
        return new JsonMappingException((Closeable)g10, msg, problem);
    }
    ...
    implements Serializable {
        ...
        void setDescription(String d10) {
            this._desc = d10;
        }
