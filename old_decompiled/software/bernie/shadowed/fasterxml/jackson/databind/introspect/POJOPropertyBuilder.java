...
implements Comparable<POJOPropertyBuilder> {
    ...
    public PropertyMetadata getMetadata() {
        if (this._metadata == null) {
            Boolean b10 = this._findRequired();
            String desc = this._findDescription();
            Integer idx = this._findIndex();
            String def = this._findDefaultValue();
            this._metadata = b10 == null && idx == null && def == null ? (desc == null ? PropertyMetadata.STD_REQUIRED_OR_OPTIONAL : PropertyMetadata.STD_REQUIRED_OR_OPTIONAL.withDescription(desc)) : PropertyMetadata.construct(b10, desc, idx, def);
    ...
    protected PropertyMetadata _getSetterInfo(PropertyMetadata metadata) {
        ...
        if (prim != null) {
            if (this._annotationIntrospector != null) {
                Boolean b10;
                if (acc != null && (b10 = this._annotationIntrospector.findMergeInfo(prim)) != null) {
                    needMerge = false;
                    if (b10.booleanValue()) {
            ...
            if (needMerge || valueNulls == null || contentNulls == null) {
                ...
                if (needMerge && acc != null && (b11 = co2.getMergeable()) != null) {
                    needMerge = false;
                    if (b11.booleanValue()) {
        ...
        if (needMerge || valueNulls == null || contentNulls == null) {
            ...
            if (needMerge && Boolean.TRUE.equals(b12 = this._config.getDefaultMergeable()) && acc != null) {
    ...
    public boolean isTypeId() {
        Boolean b10 = this.fromMemberAnnotations(new WithMember<Boolean>(){
    ...
    public JsonInclude.Value findInclusion() {
        AnnotatedMember a10 = this.getAccessor();
        JsonInclude.Value v2 = this._annotationIntrospector == null ? null : this._annotationIntrospector.findPropertyInclusion(a10);
    ...
    public void addField(AnnotatedField a10, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        this._fields = new Linked<AnnotatedField>(a10, this._fields, name, explName, visible, ignored);
    }

    public void addCtor(AnnotatedParameter a10, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        this._ctorParameters = new Linked<AnnotatedParameter>(a10, this._ctorParameters, name, explName, visible, ignored);
    }

    public void addGetter(AnnotatedMethod a10, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        this._getters = new Linked<AnnotatedMethod>(a10, this._getters, name, explName, visible, ignored);
    }

    public void addSetter(AnnotatedMethod a10, PropertyName name, boolean explName, boolean visible, boolean ignored) {
        this._setters = new Linked<AnnotatedMethod>(a10, this._setters, name, explName, visible, ignored);
    }
