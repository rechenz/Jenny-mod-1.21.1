...
implements Serializable {
    ...
    public PropertyMetadata withRequired(Boolean b10) {
        if (b10 == null ? this._required == null : b10.equals(this._required)) {
            return this;
        }
        return new PropertyMetadata(b10, this._description, this._index, this._defaultValue, this._mergeInfo, this._valueNulls, this._contentNulls);
    }
