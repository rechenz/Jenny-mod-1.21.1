...
public @interface JsonIgnoreProperties {
    ...
    Serializable {
        ...
        private static boolean _equals(Value a10, Value b10) {
            return a10._ignoreUnknown == b10._ignoreUnknown && a10._merge == b10._merge && a10._allowGetters == b10._allowGetters && a10._allowSetters == b10._allowSetters && a10._ignored.equals(b10._ignored);
        }
