...
public @interface JsonInclude {
    ...
    Serializable {
        ...
        protected Value(Include vi, Include ci2, Class<?> valueFilter, Class<?> contentFilter) {
            this._valueInclusion = vi == null ? Include.USE_DEFAULTS : vi;
            this._contentInclusion = ci2 == null ? Include.USE_DEFAULTS : ci2;
        ...
        public Value withOverrides(Value overrides) {
            ...
            Include ci2 = overrides._contentInclusion;
            ...
            boolean ciDiff = ci2 != this._contentInclusion && ci2 != Include.USE_DEFAULTS;
            boolean bl2 = filterDiff = vf != this._valueFilter || cf2 != this._valueFilter;
            if (viDiff) {
                if (ciDiff) {
                    return new Value(vi, ci2, vf, cf2);
                }
                return new Value(vi, this._contentInclusion, vf, cf2);
            }
            if (ciDiff) {
                return new Value(this._valueInclusion, ci2, vf, cf2);
            }
            if (filterDiff) {
                return new Value(this._valueInclusion, this._contentInclusion, vf, cf2);
            }
            return this;
        }
        ...
        public static Value from(JsonInclude src) {
            ...
            Include ci2 = src.content();
            if (vi == Include.USE_DEFAULTS && ci2 == Include.USE_DEFAULTS) {
                return EMPTY;
            }
