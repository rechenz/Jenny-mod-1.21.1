...
lbl28:
    ...
    public void write(int c10) throws IOException {
        if (this._surrogate > 0) {
            c10 = this.convertSurrogate(c10);
        } else if (c10 >= 55296 && c10 <= 57343) {
            if (c10 > 56319) {
                UTF8Writer.illegalSurrogate(c10);
            }
            this._surrogate = c10;
            return;
        }
        ...
        if (c10 < 128) {
            this._outBuffer[this._outPtr++] = (byte)c10;
        } else {
            int ptr = this._outPtr;
            if (c10 < 2048) {
                this._outBuffer[ptr++] = (byte)(0xC0 | c10 >> 6);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 & 0x3F);
            } else if (c10 <= 65535) {
                this._outBuffer[ptr++] = (byte)(0xE0 | c10 >> 12);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 >> 6 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 & 0x3F);
            } else {
                if (c10 > 0x10FFFF) {
                    UTF8Writer.illegalSurrogate(c10);
                }
                this._outBuffer[ptr++] = (byte)(0xF0 | c10 >> 18);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 >> 12 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 >> 6 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c10 & 0x3F);
            }
            this._outPtr = ptr;
