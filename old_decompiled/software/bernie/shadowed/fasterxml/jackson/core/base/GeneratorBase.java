...
extends JsonGenerator {
    ...
    public final boolean isEnabled(JsonGenerator.Feature f10) {
        return (this._features & f10.getMask()) != 0;
    }
    ...
    public JsonGenerator enable(JsonGenerator.Feature f10) {
        ...
        if ((mask & DERIVED_FEATURES_MASK) != 0) {
            if (f10 == JsonGenerator.Feature.WRITE_NUMBERS_AS_STRINGS) {
                this._cfgNumbersAsStrings = true;
            } else if (f10 == JsonGenerator.Feature.ESCAPE_NON_ASCII) {
                this.setHighestNonEscapedChar(127);
            } else if (f10 == JsonGenerator.Feature.STRICT_DUPLICATE_DETECTION && this._writeContext.getDupDetector() == null) {
    ...
    public JsonGenerator disable(JsonGenerator.Feature f10) {
        ...
        if ((mask & DERIVED_FEATURES_MASK) != 0) {
            ...
            } else if (f10 == JsonGenerator.Feature.STRICT_DUPLICATE_DETECTION) {
    ...
    protected final int _decodeSurrogate(int surr1, int surr2) throws IOException {
        ...
        int c10 = 65536 + (surr1 - 55296 << 10) + (surr2 - 56320);
        return c10;
    }
}
