...
Versioned {
    ...
    public JsonParser enable(Feature f10) {
        this._features |= f10.getMask();
        return this;
    }

    public JsonParser disable(Feature f10) {
        this._features &= ~f10.getMask();
        return this;
    }

    public JsonParser configure(Feature f10, boolean state) {
        if (state) {
            this.enable(f10);
        } else {
            this.disable(f10);
    ...
    public boolean isEnabled(Feature f10) {
        return f10.enabledIn(this._features);
    }
