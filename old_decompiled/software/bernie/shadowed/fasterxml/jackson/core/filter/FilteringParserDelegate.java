...
extends JsonParserDelegate {
    ...
    public FilteringParserDelegate(JsonParser p2, TokenFilter f10, boolean includePath, boolean allowMultipleMatches) {
        super(p2);
        this.rootFilter = f10;
        this._itemFilter = f10;
        this._headContext = TokenFilterContext.createRootContext(f10);
        ...
        switch (t2.id()) {
            case 3: {
                ...
                if (f10 == TokenFilter.INCLUDE_ALL) {
                    this._headContext = this._headContext.createChildArrayContext(f10, true);
                    this._currToken = t2;
                    return this._currToken;
                }
                if (f10 == null) {
                ...
                if ((f10 = this._headContext.checkValue(f10)) == null) {
                    this.delegate.skipChildren();
                    break;
                }
                if (f10 != TokenFilter.INCLUDE_ALL) {
                    f10 = f10.filterStartArray();
                }
                this._itemFilter = f10;
                if (f10 == TokenFilter.INCLUDE_ALL) {
                    this._headContext = this._headContext.createChildArrayContext(f10, true);
                ...
                this._headContext = this._headContext.createChildArrayContext(f10, false);
            ...
            case 1: {
                TokenFilter f10 = this._itemFilter;
                if (f10 == TokenFilter.INCLUDE_ALL) {
                    this._headContext = this._headContext.createChildObjectContext(f10, true);
                    this._currToken = t2;
                    return this._currToken;
                }
                if (f10 == null) {
                ...
                this._headContext = this._headContext.createChildObjectContext(f10, false);
                if (!this._includePath || (t2 = this._nextTokenWithBuffering(this._headContext)) == null) break;
                this._currToken = t2;
                return t2;
            }
            ...
            case 4: {
                ...
                TokenFilter f10 = this._headContext.getFilter();
                if (f10 != null && f10 != TokenFilter.INCLUDE_ALL) {
                    f10.filterFinishArray();
                }
            ...
            case 5: {
                ...
                TokenFilter f10 = this._headContext.setFieldName(name);
                if (f10 == TokenFilter.INCLUDE_ALL) {
                    this._itemFilter = f10;
                ...
                if ((f10 = f10.includeProperty(name)) == null) {
                    this.delegate.nextToken();
                    this.delegate.skipChildren();
                    break;
                }
            ...
            default: {
                ...
                if (f10 == null || (f10 = this._headContext.checkValue(f10)) != TokenFilter.INCLUDE_ALL && (f10 == null || !f10.includeValue(this.delegate)) || !this._verifyAllowedMatches()) break;
                this._currToken = t2;
                return this._currToken;
            }
        }
    ...
    protected final JsonToken _nextToken2() throws IOException {
        ...
        block6: while (true) {
            ...
            switch (t2.id()) {
                ...
                case 4: {
                    boolean returnEnd = this._headContext.isStartHandled();
                    f10 = this._headContext.getFilter();
                    if (f10 != null && f10 != TokenFilter.INCLUDE_ALL) {
                        f10.filterFinishArray();
                    }
                    this._headContext = this._headContext.getParent();
                ...
                case 5: {
                    String name = this.delegate.getCurrentName();
                    f10 = this._headContext.setFieldName(name);
                    if (f10 == TokenFilter.INCLUDE_ALL) {
                        this._itemFilter = f10;
                        this._currToken = t2;
                        return this._currToken;
    ...
    protected final JsonToken _nextTokenWithBuffering(TokenFilterContext buffRoot) throws IOException {
        block6: while (true) {
            ...
            switch (t2.id()) {
                case 3: {
                    f10 = this._headContext.checkValue(this._itemFilter);
                    if (f10 == null) {
                        this.delegate.skipChildren();
                        continue block6;
                    }
                ...
                case 5: {
                    ...
                    this._itemFilter = f10;
                    if (f10 != TokenFilter.INCLUDE_ALL) continue block6;
                    if (this._verifyAllowedMatches()) {
                        return this._nextBuffered(buffRoot);
                    }
