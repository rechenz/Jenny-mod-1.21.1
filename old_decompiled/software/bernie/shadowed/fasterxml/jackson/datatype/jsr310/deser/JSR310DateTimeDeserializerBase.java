...
implements ContextualDeserializer {
    ...
    protected JSR310DateTimeDeserializerBase(Class<T> supportedType, DateTimeFormatter f10) {
        super(supportedType);
        this._formatter = f10;
    }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (format != null && format.hasPattern()) {
            ...
            DateTimeFormatter df2 = locale == null ? DateTimeFormatter.ofPattern(pattern) : DateTimeFormatter.ofPattern(pattern, locale);
            if (format.hasTimeZone()) {
                df2 = df2.withZone(format.getTimeZone().toZoneId());
            }
            return this.withDateFormat(df2);
        }
        return this;
    }
}
